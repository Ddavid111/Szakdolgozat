...
\item A dolgozat nyomonkövetése és annak státuszának frissítése a rendszerben.
...
\item A hallgató dolgozatának nyomonkövetése és visszajelzések küldése.
...
A bírálati folyamat a következő nagyobb lépésekből épül fel.
...
A bírálati folyamat fő lépései az alábbiak.
